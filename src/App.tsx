...
import { VKUIWrapper } from './components/VKUIWrapper';
...
**Цель:** Развитие силы и массы ног`,
  ...
  const addWorkout = (workout: Omit<WorkoutPlan, 'id' | 'createdAt' | 'createdBy'>) => {
  ...
  const sendWorkoutInvitation = (workout: WorkoutPlan, friendId: string, _friendName: string, message?: string) => {
